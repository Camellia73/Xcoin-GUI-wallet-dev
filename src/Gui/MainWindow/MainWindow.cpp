...
const char COMMUNITY_FORUM_URL[] = "https://discord.gg/pXxmGa";
const char REPORT_ISSUE_URL[] = "https://discord.gg/pXxmGa";
...
MainWindow::MainWindow(ICryptoNoteAdapter* _cryptoNoteAdapter, IAddressBookManager* _addressBookManager,
  ...
  m_ui->setupUi(this);
  setWindowTitle(tr("Xcoin Wallet %1").arg(Settings::instance().getVersion()));
