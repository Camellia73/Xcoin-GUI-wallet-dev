...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/images/xcoin"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        m_aboutXcoinAction = new QAction(MainWindow);
        m_aboutXcoinAction->setObjectName(QStringLiteral("m_aboutXcoinAction"));
        m_aboutXcoinAction->setEnabled(true);
        ...
        menuHelp->addAction(m_aboutXcoinAction);
        ...
        QObject::connect(m_aboutXcoinAction, SIGNAL(triggered()), MainWindow, SLOT(about()));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
...
#endif // QT_NO_TOOLTIP
        m_aboutXcoinAction->setText(QApplication::translate("MainWindow", "About Xcoin", 0));
        ...
        m_sendButton->setText(QApplication::translate("MainWindow", "SEND XCOIN", 0));
